...
SELECT id, name, status, provider, place_id, place_url, latitude, longitude, formatted_address, address_components, created_at, created_by, updated_at, updated_by, deleted_at, deleted_by FROM shops
