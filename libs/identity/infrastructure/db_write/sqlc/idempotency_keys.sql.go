...
SELECT key_id, request_hash, response, status_code, created_at FROM idempotency_keys
WHERE key_id = $1
`

func (q *Queries) GetIdempotencyKeyByID(ctx context.Context, keyID pgtype.UUID) (IdempotencyKey, error) {
